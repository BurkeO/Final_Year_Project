...
public class SpectrogramTarsos extends JFrame implements PitchDetectionHandler {
    ...
    public SpectrogramTarsos(String fileName){
    ...
    public static void main(final String... strings) throws InterruptedException,
        ...
        SwingUtilities.invokeAndWait(new Runnable() {
            ...
            public void run() {
                ...
                JFrame frame = strings.length == 0 ? new SpectrogramTarsos(null) : new SpectrogramTarsos(strings[0]) ;
                frame.pack();
