...
public class MelSpectrogram  implements PitchDetectionHandler {
    ...
    public static BufferedImage convert_mp3_to_image(File mp3){
        File tempFile = new File("D:/Users/Owen/Final_Year_Project/birdsong/Common_Wood_Pigeon/Common_Wood_Pigeon_0.wav");
    ...
    public static BufferedImage convert_to_image(File f) {
        ...
        melGram.setOutputFrameWidth(Width);
        melGram.setOutputFrameHeight(Height);
    ...
    public void setOutputFrameHeight(int height)
    {
        this.outputFrameHeight = height;
    }

    public void setOutputFrameWidth(int width)
    {
        this.outputFrameWidth = width;
    }
